...
export default {
    data: new SlashCommandBuilder()
        .setName('spotify')
        .setDescription('Post a SPOTIFY product listing')
    ...
    execute: withErrorHandling(async (interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setTitle(`${EMOJIS.verify} SPOTIFY`)
            .setDescription([
                `${EMOJIS.stock} **PLAN**`,
                `**${plan}**`,
                '',
            ...
            .setFooter({ text: 'CaproStore • SPOTIFY' })
            .setTimestamp();
        ...
        await interaction.reply({
            content: `✅ Posted the **${plan} ${duration}** SPOTIFY listing.`,
            ephemeral: true,
        });
    }),
};
